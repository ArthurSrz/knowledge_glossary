...
Today we're up to prove that [[knowledge]] drives efficiency. No, let's narrow this down : we're up to prove that [[knowledge]] layers help reduce [[token]] consumption **and saves users' time**. Why would we want to prove that ? 
