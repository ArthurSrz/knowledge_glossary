...
> [!note] 
> Un [[knowledge]] [[layer]] réduit la dispersion sémantique du fait qu'il laisse de fortes traces neurologiques dans la _tête_ du modèle ; traces qui agissent comme un harnais sémantique ([[agent harness]]) réduisant la probabilité qu'un [[token]] s'éloignent d'un champ sémantique. 
