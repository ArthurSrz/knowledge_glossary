...
1. **Random Variables**: Measurable [[functions]] from Ω to a measurable space

2. **Independence**: Events A and B are independent if P(A ∩ B) = P(A)P(B)

3. **Conditional Probability**: P(A|B) = P(A ∩ B) / P(B) for P(B) > 0
